...
def main():
    ...
    weights_path = os.path.join(SAVE_DIR, 'resnet50_epoch100_20210807_142714', 'epoch60.pth')
    ...
    with torch.no_grad():
        ...
        dataframe.to_csv(os.path.join(SAVE_DIR, 'resnet50_epoch100_20210807_142714', 'epoch60.csv'), index=False, sep=',')
