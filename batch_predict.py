...
def main():
    ...
    weights_path = os.path.join(SAVE_DIR, 'resnet50_epoch70_20210809_200358', 'epoch30.pth')
    ...
    with torch.no_grad():
        ...
        dataframe.to_csv(os.path.join(SAVE_DIR, 'resnet50_epoch70_20210809_200358', 'epoch30.csv'), index=False, sep=',')
